...
#else
  (void)iov; (void)id; (void)hf3fs_mount_point; (void)size; (void)block_size; (void)device_id;
#endif
  return -ENOTSUP;
}
...
#else
  (void)iov; (void)device_ptr; (void)id; (void)hf3fs_mount_point;
  (void)size; (void)block_size; (void)device_id;
#endif
  return -ENOTSUP;
}
