...
// Parse GDR URI: gdr://v1/device/{id}/size/{size}/ipc/{hex-encoded-64-byte-handle}
...
int hf3fs_iovcreate_gpu(struct hf3fs_iov* iov,
                        ...
                        size_t block_size,
                        int gpu_device_id) {
  return hf3fs_iovcreate_gpu_internal(iov, hf3fs_mount_point, size, block_size, gpu_device_id);
}
...
int hf3fs_iovopen_gpu(struct hf3fs_iov* iov,
                      ...
                      size_t block_size,
                      int gpu_device_id) {
  return hf3fs_iovopen_gpu_internal(iov, id, hf3fs_mount_point, size, block_size, gpu_device_id);
}
...
int hf3fs_iovwrap_gpu(struct hf3fs_iov* iov,
                      ...
                      size_t block_size,
                      int gpu_device_id) {
  return hf3fs_iovwrap_gpu_internal(iov, gpu_ptr, id, hf3fs_mount_point, size, block_size, gpu_device_id);
}
...
bool hf3fs_iov_is_gpu(const struct hf3fs_iov* iov) {
  return hf3fs_iov_is_gpu_internal(iov);
}
...
int hf3fs_iov_import_gpu(struct hf3fs_iov* iov,
  ...
  // Generate UUID for the imported iov
  hf3fs::Uuid uuid = hf3fs::Uuid::random();
